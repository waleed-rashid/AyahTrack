...
const calculateStreakStats = (entries, todayValue = new Date()) => {
...
exports.calculateStreakStats = calculateStreakStats;
const calculateLongestStreakRange = (entries) => (0, exports.calculateStreakStats)(entries).longestStreakRange;
exports.calculateLongestStreakRange = calculateLongestStreakRange;
